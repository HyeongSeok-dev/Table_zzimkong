        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="${pageContext.request.contextPath }/admin/admin_user.jsp">
                    ...
                    <li class="nav-link">
                        <a href="${pageContext.request.contextPath }/admin/admin_company.jsp">
                            <i class='bx bx-store icon' ></i>
                            <span class="text nav-text">업체관리</span>
                        </a>
                    </li>

                    <li class="nav-link">
                        <a href="${pageContext.request.contextPath }/admin/admin_review.jsp">
                            <i class='bx bx-comment-detail icon' ></i>
                            <span class="text nav-text">리뷰관리</span>
                        </a>
                    </li>
