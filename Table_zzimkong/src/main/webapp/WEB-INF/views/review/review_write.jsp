...
<body>
	<div class="container">
		...
		<div class="like_section" style="text-align: center;">
			...
			<button id="likeButton" class="like_button" name="review_like">
		...
		<div class="review_section">
			...
			<div class="keyword_section">
				<div class="keyword_category">
					<h3>음식/가격</h3>
					<button class="keyword_btn" name="review_food_big">양이 많아요</button>
					<button class="keyword_btn" name="review_food_deli">음식이 맛있어요</button>
					<button class="keyword_btn" name="review_food_cheap">가성비가 좋아요</button>
					<button class="keyword_btn" name="review_food_fresh">재료가 신선해요</button>
					<button class="keyword_btn" name="review_food_healthy">건강한 맛이에요</button>
				</div>
				<div class="keyword_category">
					<h3>분위기</h3>
					<button class="keyword_btn" name="review_mood_interior">인테리어가 멋져요</button>
					<button class="keyword_btn" name="review_mood_alone">혼밥하기 좋아요</button>
					<button class="keyword_btn" name="review_mood_large">매장이 넓어요</button>
					<button class="keyword_btn" name="review_mood_meeting">단체모임 하기 좋아요</button>
					<button class="keyword_btn" name="review_mood_view">뷰가 좋아요</button>
				</div>
				<div class="keyword_category">
					<h3>편의 시설/기타</h3>
					<button class="keyword_btn" name="review_etc_kind">친절해요</button>
					<button class="keyword_btn" name="review_etc_parking">주차하기 편해요</button>
					<button class="keyword_btn" name="review_etc_toilet">화장실이 깨끗해요</button>
					<button class="keyword_btn" name="review_etc_fast">음식이 빨리 나와요</button>
					<button class="keyword_btn" name="review_etc_child">아이와 가기 좋아요</button>
				</div>
				<div class="keyword_category">
					<h3>&nbsp;&nbsp;&nbsp;&nbsp;</h3>
		...
		<div class="review_input_section">
			...
			<button class="photo_btn" id="photoBtn" style="text-align: center;">
				<i class="fas fa-camera"></i> 사진 추가 <span
					style="color: gray; font-size: 0.8em;"> (최대 5장)</span>
			</button>

			<input type="file" id="photoInput" accept="image/*" style="display: none;" multiple />

			<textarea class="review_textarea"
				placeholder="리뷰 작성하기<br>업주와 다른 사용자들이 상처받지 않도록 좋은 표현을 사용해주세요. 유용한 Tip도 남겨주세요."></textarea>
