		...
		<div class="text_inner">
			<form action="" method="post" name="comInfoModify">
				<table>
					...
					<tr>
						<th colspan="2">상호명</th>
						<td colspan="1"><input type="text" value="" readonly="readonly" name="comName" class="modify_info"></td>
						<th colspan="1">업태</th>
						<td colspan="1"><input type="text" value="" readonly="readonly" name="comState" class="modify_info"></td>
					</tr>
					<tr>
						<th colspan="2">대표자명</th>
						<td colspan="1"><input type="text" value="" readonly="readonly" name="ceoName" class="modify_info"></td>
						<th colspan="1">전화번호</th>
						<td colspan="1"><input type="text" value="" name="comPhoneNum" class="modify_info"></td>
					</tr>
					<tr>
						<th colspan="2">주소</th>
						<td colspan="3"><input type="text" name="comAdress" maxlength="5" size="50" value="" readonly="readonly" class="modify_info"></td>
					</tr>
					<tr>		    
						<th colspan="2">업체상태</th>
						<td colspan="1">
							<input type="text" id="company_state1" name="comStatus" readonly="readonly" value="영업정지" size="4"  class="modify_info">
					...
					<tr>
						...
						<td colspan="1"><input type="text" value="" name="perHourMaxTable"  class="modify_info"></td>
					...
					<tr>
						...
						<td colspan="1"><input type="text" value="" name="perResMaxPerson"  class="modify_info"></td>
