...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/main_1.css">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="block wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
							...
							<div class="title">
								<h3>부산전포 <span>별점순</span></h3>
							</div>
											
							<div id="owl-example2" class="owl-carousel">
											
								<%-- 상세페이지로 가는 이미지 --%>
									<div class="owl_example2_items_images">
										<a href="${pageContext.request.contextPath}/product/detail">
											<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/list_com.jpg" >
										</a>
									</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="block wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
							...
							<div class="title">
								<h3>부산전포 <span>반려동물 동반 가능</span></h3>
							</div>
											
							<div id="owl-example3" class="owl-carousel">
											
								<%-- 상세페이지로 가는 이미지 --%>
									<div class="owl_example3_items_images">
										<a href="${pageContext.request.contextPath}/product/detail">
											<img class="img-responsive" src="${pageContext.request.contextPath}/resources/img/list_com.jpg" >
										</a>
									</div>
